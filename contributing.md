# Contributing to spike-datocms

Hello there! First of all, thanks for being interested in spike-datocms and helping out. We all think you are awesome, and by contributing to open source projects, you are making the world a better place. That being said, there are a few ways to make the process of contributing code to spike-datocms smoother, detailed below:
